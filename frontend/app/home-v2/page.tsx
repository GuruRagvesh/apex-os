...
// Public marketing landing page — a rework-in-progress preview of what could
// become the real Apex OS home page. Deliberately kept at /home-v2 (not / or
// /home) until reviewed and approved. Server component: no client state is
// needed, every CTA is a plain link or same-page anchor.
  ...
  return (
    <div style={{ backgroundColor: '#05070c', color: '#e2e8f0' }} className="min-h-screen">
      ...
      <div className="px-4 py-2 text-center text-xs font-mono" style={{ backgroundColor: 'rgba(139,92,246,0.12)', color: '#c4b5fd', borderBottom: '1px solid rgba(139,92,246,0.2)' }}>
        Home V2 · Public preview — under review, not yet the live Apex OS home page.
      </div>

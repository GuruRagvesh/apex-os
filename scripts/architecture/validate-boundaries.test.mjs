...
testRealRepoDebtCounts({
  ...
  'DEBT-P2B1-SALES-CRM-DASHBOARD-LEGACY-FRONTEND': 10,
  'DEBT-P2B2-SALES-CRM-ANALYTICS-LEGACY-FRONTEND': 9,
  'DEBT-P2B3-SALES-CRM-DATABASE-LEGACY-FRONTEND': 7,
  'DEBT-P2B4-SALES-CRM-SETTINGS-LEGACY-FRONTEND': 12,
  'DEBT-P2B5-SALES-CRM-SHELL-LEGACY-FRONTEND': 3,
});

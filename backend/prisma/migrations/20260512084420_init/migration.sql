...
-- CreateEnum
CREATE TYPE "TicketStatus" AS ENUM ('OPEN', 'IN_PROGRESS', 'REVIEW', 'DONE', 'CLOSED');

-- CreateEnum
CREATE TYPE "TicketCategory" AS ENUM ('IT', 'FACILITIES', 'HR', 'OPERATIONS', 'PROJECT', 'ADMIN');

-- CreateEnum
CREATE TYPE "TicketType" AS ENUM ('BUG', 'FEATURE', 'TASK', 'MAINTENANCE', 'SUPPORT', 'INCIDENT', 'REQUEST');
